...
#define LIBACQUIRE_ACQUIRE_WINCOMPRESSAPI_H
    ...
    (defined(_WIN32) || defined(__WIN32__) || defined(_MSC_VER) || defined(__MINGW32__))
                    ...
                    const char *output_folder)
{
    ...
    while (1) {
        ...
        if (fread(filename, 1, header.filename_length, fzip) != header.filename_length) {
...
#endif /* defined(LIBACQUIRE_USE_WINCOMPRESSAPI) && LIBACQUIRE_USE_WINCOMPRESSAPI && \
          defined(LIBACQUIRE_IMPLEMENTATION) && defined(LIBACQUIRE_EXTRACT_IMPL) && \
          (defined(_WIN32) || defined(__WIN32__) || defined(_MSC_VER) || defined(__MINGW32__)) */

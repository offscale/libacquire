...
macro (set_ssl_lib)
    ...
    elseif (CRYPTO_LIB STREQUAL "CommonCrypto" OR CRYPTO_LIB STREQUAL "OpenSSL")
        list(APPEND _Header_Files "${abs_folder_path}/acquire_openssl.h")
    elseif (CRYPTO_LIB STREQUAL "WinCrypt")
        list(APPEND _Header_Files "${abs_folder_path}/acquire_wincrypt.h")
...
macro (set_http_https_lib)
    if (DEFINED USE_LIBFETCH
        ...
        list(APPEND _Header_Files "${abs_folder_path}/acquire_libfetch.h")
    ...
    elseif (CMAKE_SYSTEM_NAME STREQUAL "Windows")
        ...
        list(APPEND _Header_Files "${abs_folder_path}/acquire_wininet.h")
        ...
        list(APPEND _Header_Files "${abs_folder_path}/acquire_libcurl.h")
...
function (set_extract_lib)
    if (CMAKE_SYSTEM_NAME STREQUAL "Windows" AND NOT DEFINED USE_ZLIB AND NOT DEFINED USE_LIBARCHIVE)
        ...
        list(APPEND _Header_Files "${abs_folder_path}/acquire_compressapi.h")
    elseif (DEFINED USE_LIBARCHIVE)
        set(EXTRACT_LIB "LIBARCHIVE" PARENT_SCOPE)
        list(APPEND _Header_Files "${abs_folder_path}/acquire_libarchive.h")
    ...
    elseif (DEFINED USE_ZLIB)
        ...
        list(APPEND _Header_Files "${abs_folder_path}/acquire_zlib.h")
    else ()
        set(USE_MINIZ 1 PARENT_SCOPE)
        set(EXTRACT_LIB "MINIZ" PARENT_SCOPE)
        list(APPEND _Header_Files "${abs_folder_path}/acquire_miniz.h")
    endif ()
...
function (set_checksum_lib)
    ...
    if (LibRHash_FOUND)
        ...
        add_compile_definitions(USE_LIBRHASH=1)
    else ()
